...
st.markdown("<h1 style='text-align: center; color: #1E88E5;'>✏️เกมเติมคำศัพท์ภาษาอังกฤษ</h1>", unsafe_allow_html=True)
st.write("คำชี้แจง:ให้นักเรียนเติมคำศัพท์ภาษาอังกฤษที่ขาดหายไปในประโยคให้ถูกต้อง")
